...
<div id="signin">
  <div class="messages"><p class="info">登录成功</p></div>
  <div id="customlogo">
       <img src="${viewPath}/images/bg_logo.gif">
  </div>
 
  <div id="logins">
	<p><img src="${viewPath}/images/ok_small.gif" style="padding-right:2px"/>您已成功登录系统。 | <span><a href="${contextPath}/signon/logout">注销</a></span></p>
	<p style="margin-left:18px;margin-top:5px">您可以：</p>
	<ul style="margin-left:18px;">
		...
		<li>
			&nbsp;&nbsp;2.
	         <span>点击收藏夹或者在地址栏中输入地址进入您要访问的系统。</span>
	      </li>
    </ul>
  </div>
